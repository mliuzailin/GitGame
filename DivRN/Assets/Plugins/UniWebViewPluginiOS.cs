...
public class UniWebViewPlugin {
    ...
    [DllImport("__Internal")]
    private static extern void _UniWebViewSetHomeDomain(string text);
    [DllImport("__Internal")]
    private static extern void _UniWebViewSetInBrowserUrls(string text);
    [DllImport("__Internal")]
    ...
    public static void SetHomeDomain(string text) {
        if (Application.platform == RuntimePlatform.IPhonePlayer) {
            _UniWebViewSetHomeDomain(text);
        }
    }

    public static void SetInBrowserUrls(string text) {
        if (Application.platform == RuntimePlatform.IPhonePlayer) {
            _UniWebViewSetInBrowserUrls(text);
        }
    }
