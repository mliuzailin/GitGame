...
public static class ListExtensions
{
	...
	public static bool IsRange<T>(this List<T> data, int index) {
		return ((index >= 0) && (index < data.Count));
	}

	public static bool IsRange<T>(this T[] data, int index) {
		return ((index >= 0) && (index < data.Length));
	}


	public static bool IsOverRange<T>(this List<T> data, int index) {
		return ((index < 0) || (index >= data.Count));
	}

	public static bool IsOverRange<T>(this T[] data, int index) {
		return ((index < 0) || (index >= data.Length));
	}
