...
public class FindObjects : ScriptableWizard
{
    ...
    //まだ検索してないと true  
    static bool noSearch = true;

    //Menu item starts wizard  
    [MenuItem("Tools/Find Objects/Find Objects ...")]

    static void FindMenuItem()
    {
        ScriptableWizard.DisplayWizard("Find Objects", typeof(FindObjects), "Close", "Find Next");
    }
    ...
    [MenuItem("Tools/Find Objects/Find Objects Next %g")]
    ...
    [MenuItem("Tools/Find Objects/Find Objects Next %g", true)]
    ...
    [MenuItem("Tools/Find Objects/Find Objects Prev #%g")]
    ...
    [MenuItem("Tools/Find Objects/Find Objects Prev #%g", true)]
