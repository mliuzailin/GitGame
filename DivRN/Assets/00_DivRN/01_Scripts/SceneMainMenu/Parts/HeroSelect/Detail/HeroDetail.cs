...
public class HeroDetail : MenuPartsBase
{
    ...
    M4uProperty<List<HeroStoryListItemContext>> stories = new M4uProperty<List<HeroStoryListItemContext>>(new List<HeroStoryListItemContext>());
    public List<HeroStoryListItemContext> Stories
    {
        get
        {
