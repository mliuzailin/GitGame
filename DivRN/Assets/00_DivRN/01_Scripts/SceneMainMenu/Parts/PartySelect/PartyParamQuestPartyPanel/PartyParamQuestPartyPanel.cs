/**
 *  @file   PartyParamQuestPartyPanel.cs
 *  @brief
 *  @author Developer
 *  @date   2017/03/13
 */
...
public class PartyParamQuestPartyPanel : MenuPartsBase
{
    ...
    public void SetUpLinkUnit(bool isShow)
    {
        ...
        {
            PartyParamQuestListItem panelImtem = PartyParamList[party_count].GetComponent<PartyParamQuestListItem>();
            if (panelImtem == null)
            {
                continue;
            }
