...
public class RecyclableItemsScrollContent : UIBehaviour
{
    ...
    void Update()
    {
        ...
        while (true)
        {
            ...
            if (itemScale <= 0 || AnchoredPosition - diffPreFramePosition >= -(itemScale + spacing) * lineBufferSize)
            {
                break;
            }
        ...
        while (true)
        {
            ...
            if (itemScale <= 0 || AnchoredPosition - diffPreFramePosition <= -(itemScale + spacing) * (lineBufferSize - 1))
            {
                break;
            }
